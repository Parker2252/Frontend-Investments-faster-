                  ...
                  <form ref="form">
                    <div class="container-fluid">
                      <div class="form-group row justify-content-around py-2">
                        ...
                        <div class="col col-8">
                          <input v-model="stock.cust_number" type="form-select" class="form-control-sm form-control">
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Name</label>
                        <div class="col col-8">
                          <input v-model="stock.name" type="form-select" class="form-control-sm form-control">
                        </div>
                      </div>          
                      <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="form-group row justify-content-around py-2">
                        ...
                        <div class="col col-8">
                          <input v-model="stock.purchase_price" type="text" class="form-control-sm form-control">
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
